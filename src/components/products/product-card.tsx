...
export function ProductCard({ id, name, brand, price, image, badge, rating }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="relative aspect-square overflow-hidden rounded-2xl bg-gray-100 dark:bg-surface-card-dark mb-4">
        {/* Badge */}
        {badge && (
        ...
        <button
          ...
          className="absolute top-3 right-3 z-10 w-10 h-10 bg-white dark:bg-surface-dark rounded-full flex items-center justify-center shadow-md hover:scale-110 transition-transform"
        >
          <motion.div
